...
//#include "msp430.h"                                       /* ע��MSP430������ͷ�ļ� */
//#include "msp430_i2c.h"
//#include "msp430_clock.h"
//#include "msp430_interrupt.h"
#include "atk_ms6050.h"                    /* �������ͷ�ļ� */
#include "delay.h"
#include "inv_mpu_dmp_motion_driver.h"
#define i2c_write   atk_ms6050_write                        /* IICдͨѶ���� */
#define i2c_read    atk_ms6050_read                         /* IIC��ͨѶ���� */
#define delay_ms    delay_ms                                /* ���뼶��ʱ���� */
#define get_ms      atk_ms6050_get_clock_ms                 /* ��ȡ���뼶ʱ������� */
static inline int reg_int_cb(struct int_param_s *int_param) /* �жϻص�������δʵ�֣� */
{
//    return msp430_reg_int_cb(int_param->cb, int_param->pin, int_param->lp_exit,
//        int_param->active_low);
    return 0;
}
#define log_i(...)     do {} while (0)                      /* ��ӡLOG��ͨ��Ϣ */
#define log_e(...)     do {} while (0)                      /* ��ӡLOG������Ϣ */
 ...
 * @note        ��ȡ���ݵ�Ƶ�������DEFAULT_MPU_HZ�����Ƶ��һ�£�
 *              ��ȡ̫�죬������ATK-MS6050��δ�������ݲ���������FIFO�������ݣ��Ӷ���ȡʧ�ܣ�
 *              ��ȡ̫���������޷���ʱ����ATK-MS6050 FIFO�е����ݣ�����FIFO������Ӷ���ȡʧ��
 * @param       pitch: �����ǣ�����: 0.1�� ��Χ:  -90.0�� <--->  +90.0�㣩
 *              roll : ����ǣ�����: 0.1�� ��Χ: -180.0�� <---> +180.0�㣩
 *              yaw  : ����ǣ�����: 0.1�� ��Χ: -180.0�� <---> +180.0�㣩
 * @retval      0: ����ִ�гɹ�
 *              1: ����ִ��ʧ��
 */
uint8_t atk_ms6050_dmp_get_data(float *pitch, float *roll, float *yaw)
{
    ...
    /* ��ȡATK-MS6050 FIFO�����ݵ�Ƶ�������DEFAULT_MPU_HZ�����Ƶ��һֱ
     * ��ȡ��̫���̫�������ܵ��¶�ȡʧ��
     * ��ȡ̫�죺ATK-MS6050��δ������FIFO�������ݣ���ȡʧ��
     * ��ȡ̫����ATK-MS6050��FIFO�������ȡʧ��
     */
